...
async function initMovimientos() {
    ...
    movimientos.forEach(movimiento => {
        ...
        mov.row.add([`{"movimiento":"${movimiento.id_movimiento}","clasificacion":"${movimiento.class}"}`, movimiento.proveedor, movimiento.destino || "", (movimiento.no_parte == 5) ? movimiento.peso : movimiento.no_parte, movimiento.descripcion, movimiento.fechaf, movimiento.cant_parte, movimiento.cant_anterior, movimiento.cant_posterior, `<button type="button" class="btn btn-primary editar" data-toggle="modal" title="Detalles" data-target="#modal-${movimiento.id_movimiento}"><span class="fa fa-eye"></span></button>`]).draw();
