...
api.post('/BillOfLanding', function (req, res) {
    ...
    wb.write(path.resolve(__dirname,`/docs/Bill Of Landing ${info.cliente[0].nombre} ${fecha.getDate()} de ${meses[fecha.getMonth()]} de ${fecha.getFullYear()}.xlsx`), function (err) {
        if (err) throw err
        else {
